...
{
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] app_task_handler enter\n");
    ...
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] before perf/sys timer init\n");
    ...
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] before early_initcall\n");
    __do_initcall(early_initcall);
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] before board_early_init\n");
    board_early_init();
#ifdef CONFIG_SDFILE_EXT_ENABLE
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] before sdfile_ext_mount_init\n");
    sdfile_ext_mount_init();
#endif
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] before platform_initcall\n");
    ...
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] before board_init\n");
    board_init();
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] after board_init\n");
    ...
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] after initcall\n");
    __do_initcall(module_initcall);
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] after module_initcall\n");
    app_core_init();
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] after app_core_init\n");
    __do_initcall(late_initcall);
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] before app_main\n");

    app_main();
    DEMO_UI_BOOT_PUTS("[demo_ui_boot] after app_main\n");
