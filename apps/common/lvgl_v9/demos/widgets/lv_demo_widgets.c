...
void shop_create(lv_obj_t *parent)
{
    ...
    LV_IMAGE_DECLARE(ban_button_gif);
    create_shop_item(list, &ban_button_gif, "Blue T-shirt", "Clothes", "$722");
    create_shop_item(list, &ban_button_gif, "Blue T-shirt", "Clothes", "$411");
    create_shop_item(list, &ban_button_gif, "Blue T-shirt", "Clothes", "$917");
    create_shop_item(list, &ban_button_gif, "Blue T-shirt", "Clothes", "$64");
    create_shop_item(list, &ban_button_gif, "Blue T-shirt", "Clothes", "$805");
