...
#define LV_COLOR_DEPTH_EXTEN LV_COLOR_DEPTH   /* PC sim: disable ARGB8565 extension */
#else
...
#define LV_USE_JLFFMPEG 0   /* 开机动画改用自解码(simple_avi_unpkg + 硬件JPEG),不走jlffmpeg/jlstream音频栈 */
#if LV_USE_JLFFMPEG
