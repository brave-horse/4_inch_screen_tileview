...
void setup_scr_screen_3(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_3_btn_1_label, "餐厅");
    ...
    lv_obj_set_pos(ui->screen_3_btn_1, 370, 7);
    lv_obj_set_size(ui->screen_3_btn_1, 59, 36);
    ...
    lv_obj_set_style_text_font(ui->screen_3_btn_1, &lv_font_ZiTiQuanWeiJunHeiW22_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_3_btn_2, 10, 43);
    lv_obj_set_size(ui->screen_3_btn_2, 59, 36);
    ...
    lv_obj_set_style_text_font(ui->screen_3_btn_2, &lv_font_ZiTiQuanWeiJunHeiW22_16, LV_PART_MAIN|LV_STATE_DEFAULT);
