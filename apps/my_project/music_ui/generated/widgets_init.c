...
extern int screen_digital_clock_3_hour_value;
extern int screen_digital_clock_3_min_value;
extern int screen_digital_clock_3_sec_value;

void screen_digital_clock_3_timer(lv_timer_t *timer)
{
    clock_count_24(&screen_digital_clock_3_hour_value, &screen_digital_clock_3_min_value, &screen_digital_clock_3_sec_value);
    if (lv_obj_is_valid(guider_ui.screen_digital_clock_3))
    {
        lv_dclock_set_text_fmt(guider_ui.screen_digital_clock_3, "%d:%02d", screen_digital_clock_3_hour_value, screen_digital_clock_3_min_value);
    }
}

extern int screen_digital_clock_2_hour_value;
extern int screen_digital_clock_2_min_value;
extern int screen_digital_clock_2_sec_value;
...
void screen_digital_clock_2_timer(lv_timer_t *timer)
{
    ...
    {
        lv_dclock_set_text_fmt(guider_ui.screen_digital_clock_2, "%d:%02d", screen_digital_clock_2_hour_value, screen_digital_clock_2_min_value);
    }
}
