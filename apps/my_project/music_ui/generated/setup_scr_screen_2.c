...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_2_btn_1_label, "客厅");
    ...
    lv_obj_set_pos(ui->screen_2_btn_1, 370, 6);
    lv_obj_set_size(ui->screen_2_btn_1, 59, 36);
    ...
    lv_obj_set_style_bg_color(ui->screen_2_btn_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_1, &lv_font_ZiTiQuanWeiJunHeiW22_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_2_btn_2, 7, 31);
    lv_obj_set_size(ui->screen_2_btn_2, 59, 36);
    ...
    lv_obj_set_style_bg_color(ui->screen_2_btn_2, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_2, &lv_font_ZiTiQuanWeiJunHeiW22_16, LV_PART_MAIN|LV_STATE_DEFAULT);
