...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_1_btn_1_label, "门厅");
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 370, 7);
    lv_obj_set_size(ui->screen_1_btn_1, 59, 36);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_1, &lv_font_ZiTiQuanWeiJunHeiW22_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_btn_2, 12, 43);
    lv_obj_set_size(ui->screen_1_btn_2, 48, 33);
    ...
    lv_obj_set_style_bg_color(ui->screen_1_btn_2, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_2, &lv_font_ZiTiQuanWeiJunHeiW22_16, LV_PART_MAIN|LV_STATE_DEFAULT);
