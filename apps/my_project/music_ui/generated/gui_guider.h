...
typedef struct
{
	...
	lv_obj_t *screen_digital_clock_3;
...
LV_IMG_DECLARE(_442_800x480);
LV_IMG_DECLARE(_442_alpha_270x332);
LV_IMG_DECLARE(_qing_alpha_70x64);
LV_IMG_DECLARE(_drop_alpha_343x519);

LV_FONT_DECLARE(lv_font_ZiTiQuanWeiJunHeiW22_54)
