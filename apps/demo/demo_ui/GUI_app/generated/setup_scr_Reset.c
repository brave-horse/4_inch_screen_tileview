...
void setup_scr_Reset(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->Reset_btn_2, lv_color_hex(0x232425), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes Reset_btn_5
    ui->Reset_btn_5 = lv_btn_create(ui->Reset);
    ui->Reset_btn_5_label = lv_label_create(ui->Reset_btn_5);
    lv_label_set_text(ui->Reset_btn_5_label, "重启");
    lv_label_set_long_mode(ui->Reset_btn_5_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->Reset_btn_5_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->Reset_btn_5, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->Reset_btn_5_label, LV_PCT(100));
    lv_obj_set_pos(ui->Reset_btn_5, 400, 600);
    lv_obj_set_size(ui->Reset_btn_5, 290, 70);

    //Write style for Reset_btn_5, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->Reset_btn_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Reset_btn_5, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Reset_btn_5, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Reset_btn_5, &lv_font_MiSansNormal_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Reset_btn_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Reset_btn_5, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Reset_btn_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Reset_btn_5, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->Reset_btn_5, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Reset_btn_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
