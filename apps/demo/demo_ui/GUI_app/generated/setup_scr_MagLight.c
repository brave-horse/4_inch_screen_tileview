...
void setup_scr_MagLight(lv_ui *ui)
{
    ...
    //Write codes MagLight_cont_2
    ui->MagLight_cont_2 = lv_obj_create(ui->MagLight);
    lv_obj_set_pos(ui->MagLight_cont_2, 98, -509);
    lv_obj_set_size(ui->MagLight_cont_2, 524, 392);
    lv_obj_set_scrollbar_mode(ui->MagLight_cont_2, LV_SCROLLBAR_MODE_OFF);

    //Write style for MagLight_cont_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->MagLight_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->MagLight_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->MagLight_cont_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->MagLight_cont_2, lv_color_hex(0x171717), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->MagLight_cont_2, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->MagLight_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->MagLight_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->MagLight_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->MagLight_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->MagLight_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes MagLight_img_7
    ui->MagLight_img_7 = lv_img_create(ui->MagLight_cont_2);
    lv_obj_add_flag(ui->MagLight_img_7, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->MagLight_img_7, &_LSscene1_alpha_112x140);
    lv_img_set_pivot(ui->MagLight_img_7, 50,50);
    lv_img_set_angle(ui->MagLight_img_7, 0);
    lv_obj_set_pos(ui->MagLight_img_7, 40, 29);
    lv_obj_set_size(ui->MagLight_img_7, 112, 140);

    //Write style for MagLight_img_7, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->MagLight_img_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->MagLight_img_7, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->MagLight_img_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->MagLight_img_7, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes MagLight_img_6
    ui->MagLight_img_6 = lv_img_create(ui->MagLight_cont_2);
    lv_obj_add_flag(ui->MagLight_img_6, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->MagLight_img_6, &_LSscene2_alpha_112x140);
    lv_img_set_pivot(ui->MagLight_img_6, 50,50);
    lv_img_set_angle(ui->MagLight_img_6, 0);
    lv_obj_set_pos(ui->MagLight_img_6, 210, 29);
    lv_obj_set_size(ui->MagLight_img_6, 112, 140);

    //Write style for MagLight_img_6, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->MagLight_img_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->MagLight_img_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->MagLight_img_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->MagLight_img_6, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes MagLight_img_5
    ui->MagLight_img_5 = lv_img_create(ui->MagLight_cont_2);
    lv_obj_add_flag(ui->MagLight_img_5, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->MagLight_img_5, &_LSscene3_alpha_112x140);
    lv_img_set_pivot(ui->MagLight_img_5, 50,50);
    lv_img_set_angle(ui->MagLight_img_5, 0);
    lv_obj_set_pos(ui->MagLight_img_5, 380, 29);
    lv_obj_set_size(ui->MagLight_img_5, 112, 140);

    //Write style for MagLight_img_5, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->MagLight_img_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->MagLight_img_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->MagLight_img_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->MagLight_img_5, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes MagLight_img_4
    ui->MagLight_img_4 = lv_img_create(ui->MagLight_cont_2);
    lv_obj_add_flag(ui->MagLight_img_4, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->MagLight_img_4, &_LSscene4_alpha_112x140);
    lv_img_set_pivot(ui->MagLight_img_4, 50,50);
    lv_img_set_angle(ui->MagLight_img_4, 0);
    lv_obj_set_pos(ui->MagLight_img_4, 40, 204);
    lv_obj_set_size(ui->MagLight_img_4, 112, 140);

    //Write style for MagLight_img_4, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->MagLight_img_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->MagLight_img_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->MagLight_img_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->MagLight_img_4, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes MagLight_img_3
    ui->MagLight_img_3 = lv_img_create(ui->MagLight_cont_2);
    lv_obj_add_flag(ui->MagLight_img_3, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->MagLight_img_3, &_LSscene5_alpha_112x140);
    lv_img_set_pivot(ui->MagLight_img_3, 50,50);
    lv_img_set_angle(ui->MagLight_img_3, 0);
    lv_obj_set_pos(ui->MagLight_img_3, 210, 204);
    lv_obj_set_size(ui->MagLight_img_3, 112, 140);

    //Write style for MagLight_img_3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->MagLight_img_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->MagLight_img_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->MagLight_img_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->MagLight_img_3, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes MagLight_img_2
    ui->MagLight_img_2 = lv_img_create(ui->MagLight_cont_2);
    lv_obj_add_flag(ui->MagLight_img_2, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->MagLight_img_2, &_LSscene6_alpha_112x140);
    lv_img_set_pivot(ui->MagLight_img_2, 50,50);
    lv_img_set_angle(ui->MagLight_img_2, 0);
    lv_obj_set_pos(ui->MagLight_img_2, 380, 204);
    lv_obj_set_size(ui->MagLight_img_2, 112, 140);

    //Write style for MagLight_img_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->MagLight_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->MagLight_img_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->MagLight_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->MagLight_img_2, true, LV_PART_MAIN|LV_STATE_DEFAULT);
