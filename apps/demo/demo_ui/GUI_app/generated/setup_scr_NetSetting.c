...
void setup_scr_NetSetting(lv_ui *ui)
{
    ...
    //Write codes NetSetting_label_1
    ui->NetSetting_label_1 = lv_label_create(ui->NetSetting);
    lv_label_set_text(ui->NetSetting_label_1, "设备已经绑定米家App");
    lv_label_set_long_mode(ui->NetSetting_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->NetSetting_label_1, 193, 152);
    lv_obj_set_size(ui->NetSetting_label_1, 334, 32);

    //Write style for NetSetting_label_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->NetSetting_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->NetSetting_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->NetSetting_label_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->NetSetting_label_1, &lv_font_MiSansNormal_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->NetSetting_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->NetSetting_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->NetSetting_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->NetSetting_label_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->NetSetting_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->NetSetting_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->NetSetting_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->NetSetting_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->NetSetting_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->NetSetting_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes NetSetting_img_2
    ui->NetSetting_img_2 = lv_img_create(ui->NetSetting);
    lv_obj_add_flag(ui->NetSetting_img_2, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->NetSetting_img_2, &_Sstartbind_alpha_136x145);
    lv_img_set_pivot(ui->NetSetting_img_2, 50,50);
    lv_img_set_angle(ui->NetSetting_img_2, 0);
    lv_obj_set_pos(ui->NetSetting_img_2, -349, 254);
    lv_obj_set_size(ui->NetSetting_img_2, 136, 145);

    //Write style for NetSetting_img_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->NetSetting_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->NetSetting_img_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->NetSetting_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->NetSetting_img_2, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->NetSetting_img_3, &_Sbind_alpha_71x71);
    lv_img_set_pivot(ui->NetSetting_img_3, 50,50);
    lv_img_set_angle(ui->NetSetting_img_3, 0);
    lv_obj_set_pos(ui->NetSetting_img_3, 307, 296);
    lv_obj_set_size(ui->NetSetting_img_3, 71, 71);
    ...
    //Write codes NetSetting_btn_2
    ui->NetSetting_btn_2 = lv_btn_create(ui->NetSetting);
    ui->NetSetting_btn_2_label = lv_label_create(ui->NetSetting_btn_2);
    lv_label_set_text(ui->NetSetting_btn_2_label, "解除设备");
    lv_label_set_long_mode(ui->NetSetting_btn_2_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->NetSetting_btn_2_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->NetSetting_btn_2, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->NetSetting_btn_2_label, LV_PCT(100));
    lv_obj_set_pos(ui->NetSetting_btn_2, 207, 578);
    lv_obj_set_size(ui->NetSetting_btn_2, 306, 50);

    //Write style for NetSetting_btn_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->NetSetting_btn_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->NetSetting_btn_2, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->NetSetting_btn_2, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->NetSetting_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->NetSetting_btn_2, 14, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->NetSetting_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->NetSetting_btn_2, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->NetSetting_btn_2, &lv_font_montserratMedium_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->NetSetting_btn_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->NetSetting_btn_2, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->NetSetting_img_4, -755, 152);
    ...
    lv_obj_set_pos(ui->NetSetting_btn_3, -458, 602);
    ...
    lv_obj_set_style_text_font(ui->NetSetting_btn_3, &lv_font_montserratMedium_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes NetSetting_label_2
    ui->NetSetting_label_2 = lv_label_create(ui->NetSetting);
    lv_label_set_text(ui->NetSetting_label_2, "设备未绑定米家");
    lv_label_set_long_mode(ui->NetSetting_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->NetSetting_label_2, -447, 52);
    lv_obj_set_size(ui->NetSetting_label_2, 334, 32);

    //Write style for NetSetting_label_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->NetSetting_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->NetSetting_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->NetSetting_label_2, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->NetSetting_label_2, &lv_font_MiSansNormal_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->NetSetting_label_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->NetSetting_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->NetSetting_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->NetSetting_label_2, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->NetSetting_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->NetSetting_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->NetSetting_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->NetSetting_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->NetSetting_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->NetSetting_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
