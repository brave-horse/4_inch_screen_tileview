...
void setup_scr_huifuchuchangshezhi(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->huifuchuchangshezhi_btn_2, 30, 600);
    lv_obj_set_size(ui->huifuchuchangshezhi_btn_2, 290, 70);
    ...
    lv_obj_set_pos(ui->huifuchuchangshezhi_btn_3, 400, 600);
    lv_obj_set_size(ui->huifuchuchangshezhi_btn_3, 290, 70);
