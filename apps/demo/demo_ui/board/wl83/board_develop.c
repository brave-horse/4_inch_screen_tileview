...
{
    puts("[demo_ui_boot] board_early_init enter\n");
    puts("[demo_ui_boot] before board_power_init\n");
    board_power_init();
    puts("[demo_ui_boot] after board_power_init\n");

    puts("[demo_ui_boot] before devices_init\n");
    devices_init();
    puts("[demo_ui_boot] after devices_init\n");
}
